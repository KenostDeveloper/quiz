    ...
    <div class="QuizRadioButton">
        <div v-for="(item, index) in options.fields" v-bind:key="index">
            <div class="quiz-button-radio">
                <input :value="item.name" v-model="data.value[0]" v-on:change="actionElem" class="quiz-button-radio__input" name="radio" v-bind:id="'radio_'+quiz_id+'_'+options.index+'_'+index" type="radio">
